...
export class CmsTripValidationMessage {
  ...
  static readonly DRIVER_TOO_LONG =
    'Mã tài xế không được vượt quá 24 ký tự';
  static readonly DRIVER_NOT_FOUND =
  ...
  static readonly ARRIVAL_TOO_LONG =
    'Giờ đến không được vượt quá 50 ký tự';

  static readonly BOOKED_SEATS_INVALID =
    'Số ghế đã đặt phải là số nguyên >= 0';
  ...
  static readonly OCCUPANCY_RATE_INVALID =
