...
export class CmsDriverValidationMessage {
  ...
  static readonly LICENSE_TOO_LONG =
    'Loại bằng lái không được vượt quá 50 ký tự';
  ...
  static readonly LICENSE_NUM_TOO_LONG =
  ...
  static readonly DRIVER_STATUS_NOT_IN =
    'Trạng thái tài xế không hợp lệ. Chọn: sẵn sàng, đang chạy tuyến, ngoài ca, hoặc nghỉ phép';
